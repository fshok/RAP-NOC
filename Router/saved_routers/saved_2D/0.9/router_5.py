...
with open("routes_5.txt", "wb") as fp:
	pickle.dump(roads, fp)
with open("reliabilities_5.txt", "wb") as fp:
	pickle.dump(reliabilities, fp)
with open("data_loss_5.txt", "wb") as fp:

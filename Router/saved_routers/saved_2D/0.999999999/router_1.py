			...
			if set1[1]!=None:
				...
				if ok==1:
					...
					if MRs[current_MR].dest !=None and len(set1)<3 and app==0:
						if (MRs[current_MR].dest=="north" and MRs[road[0][0]-1].source!="north") or (MRs[current_MR].dest=="south" and MRs[road[0][0]-1].source!="south") or (MRs[current_MR].dest=="east" and MRs[road[0][0]-1].source!="east") or (MRs[current_MR].dest=="west" and MRs[road[0][0]-1].source!="west") or (MRs[current_MR].dest=="ejection" and MRs[road[0][0]-1].source!="injection"):
...
with open("routes_1.txt", "wb") as fp:
	pickle.dump(roads, fp)
with open("reliabilities_1.txt", "wb") as fp:
	pickle.dump(reliabilities, fp)
with open("data_loss_1.txt", "wb") as fp:

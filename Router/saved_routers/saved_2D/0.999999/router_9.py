...
def road_finder( current_direction, current_MR ):
	pp=0
	op_direction=None
	if current_direction == "ul":
		op_direction = "dl"
	if current_direction == "dl":
		op_direction = "ul"
			...
			if set1[1]!=None:
				...
				if ok==1:
					...
					if MRs[current_MR].dest !=None and len(set1)<3 and app==0:
						if (MRs[current_MR].dest=="ur" and MRs[road[0][0]-1].source!="ur") or (MRs[current_MR].dest=="ul" and MRs[road[0][0]-1].source!="ul") or (MRs[current_MR].dest=="dr" and MRs[road[0][0]-1].source!="dr") or (MRs[current_MR].dest=="dl" and MRs[road[0][0]-1].source!="dl"):
...
with open("routes_9.txt", "wb") as fp:
	pickle.dump(roads, fp)
with open("reliabilities_9.txt", "wb") as fp:
	pickle.dump(reliabilities, fp)
with open("data_loss_9.txt", "wb") as fp:

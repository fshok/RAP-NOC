...
with open("routes_4.txt", "wb") as fp:
	pickle.dump(roads, fp)
with open("reliabilities_4.txt", "wb") as fp:
	pickle.dump(reliabilities, fp)
with open("data_loss_4.txt", "wb") as fp:

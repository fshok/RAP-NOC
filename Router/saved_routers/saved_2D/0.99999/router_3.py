...
with open("routes_3.txt", "wb") as fp:
	pickle.dump(roads, fp)
with open("reliabilities_3.txt", "wb") as fp:
	pickle.dump(reliabilities, fp)
with open("data_loss_3.txt", "wb") as fp:
